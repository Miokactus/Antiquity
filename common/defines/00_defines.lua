...
NGame = {
	...
	FUEL_RESOURCE = "grain",							-- resource that will give country fuel
...
NMilitary = {
	...
	OUT_OF_FUEL_EQUIPMENT_MULT = 0.05,				-- ratio of the stats that you get from equipments that uses fuel and you lack it
